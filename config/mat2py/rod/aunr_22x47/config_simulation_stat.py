...
# ============================================================================
# Stat (Quasistatic) Simulation - 22x47 Au Nanorod
# ============================================================================
# MATLAB reference: ~/temporary/mat2py/rod/stat/aunr_22x47/

args['use_parallel'] = False
args['num_workers'] = 1
args['wavelength_chunk_size'] = 10

args['simulation_name'] = 'aunr_22x47'
...
args['output_dir'] = os.path.join(Path.home(), 'research/mat2py/rod/stat/aunr_22x47')
