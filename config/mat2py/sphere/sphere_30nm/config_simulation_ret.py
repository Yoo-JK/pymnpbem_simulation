...
# ============================================================================
# Ret (Retarded) Simulation - 30nm Au Sphere
# ============================================================================
# MATLAB reference: ~/temporary/sphere/ret/sphere_30nm/

args['use_parallel'] = False
args['num_workers'] = 2
args['wavelength_chunk_size'] = 10

args['simulation_name'] = 'sphere_30nm'
...
args['output_dir'] = os.path.join(Path.home(), 'research/mat2py/sphere/ret/sphere_30nm')
