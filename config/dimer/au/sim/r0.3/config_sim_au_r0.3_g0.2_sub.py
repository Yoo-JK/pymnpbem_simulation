...
Source: config_sim_au_r0.3_g0.2_sub.py
"""
...
# Simulation identity
args['simulation_name'] = 'au_r0.3_g0.2_sub'
...
args['field_wavelength_idx'] = [568, 677, 713, 775, 816, 900, 554, 618, 683, 705, 760, 804, 884]
args['export_field_arrays'] = False
args['field_hotspot_count'] = 10
args['field_hotspot_min_distance'] = 3

# Output settings
args['output_dir'] = os.path.join(Path.home(), 'research/pymnpbem/au_dimer/sub')
