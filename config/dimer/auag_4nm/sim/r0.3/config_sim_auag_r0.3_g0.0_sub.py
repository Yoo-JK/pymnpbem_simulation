...
Source: config_sim_auag_r0.3_g0.0_sub.py
"""
...
# Simulation identity
args['simulation_name'] = 'auag_r0.3_g0.0_sub'

# Solver method
args['simulation_type'] = 'ret_layer'
args['interp'] = 'curv'
...
args['field_wavelength_idx'] = [506, 510, 544, 553, 581, 591, 596, 603, 613, 617, 636, 642, 668, 673, 708, 713, 773, 779, 859, 879, 889]
