...
Usage:
  python run_simulation.py \
      --str-conf config_structure.py \
      --sim-conf config_simulation.py
...
# args['materials'] = ['gold']
# Legacy mode (optional): use nphi, ntheta instead of mesh_density
# args['nphi'] = 15
# args['ntheta'] = 20
...
#                  # NOTE: gap > 0 is NOT allowed (cubes would be separated)
...
# --- Core-Shell Mode ---
# Add shell_layers to enable core-shell mode:
...
# Example 5: Au@Ag dimer with fused Ag shells (cores separate)
# args['structure'] = 'connected_dimer_cube'
# args['core_size'] = 30
# args['shell_layers'] = [5]  # shell_size = 40nm, enables core-shell mode
# args['gap'] = -2  # shell overlap = 2nm, core_gap = 8nm (separate)
# args['materials'] = ['gold', 'silver']  # [core, shell]
# args['rounding'] = 0.25
# args['mesh_density'] = 2

# Example 6: Au@Ag dimer with BOTH cores and shells fused
# args['structure'] = 'connected_dimer_cube'
# args['core_size'] = 30
# args['shell_layers'] = [5]
...
# Example 7: Per-layer rounding control for core-shell
# args['structure'] = 'connected_dimer_cube'
# args['core_size'] = 30
# args['shell_layers'] = [5]
# args['gap'] = -2
# args['materials'] = ['gold', 'silver']
# args['roundings'] = [0.15, 0.35]  # [core_rounding, shell_rounding]
# args['mesh_density'] = 2
...
# args['substrate'] = {'material': 'gold', 'gap': 0.001}
