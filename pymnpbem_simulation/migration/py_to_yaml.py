...
_KEY_TO_SECTION = {
    ...
    'save_plots': ('analysis', 'save_plots'),
    'plot_format': ('analysis', 'plot_format'),
    'plot_dpi': ('analysis', 'plot_dpi'),
    ...
    'field_nmax': ('analysis', 'field_nmax'),
    'field_wavelength_idx': ('analysis', 'field_wavelength_idx'),
    'export_field_arrays': ('analysis', 'export_field_arrays'),
    'field_hotspot_count': ('analysis', 'field_hotspot_count'),
    'field_hotspot_min_distance': ('analysis', 'field_hotspot_min_distance'),
    'run_eigenmode_analysis': ('analysis', 'run_eigenmode_analysis'),
    'eigenmode_n': ('analysis', 'eigenmode_n'),
    'eigenmode_top_k': ('analysis', 'eigenmode_top_k'),
    'retarded_eigen_wavelength': ('analysis', 'retarded_eigen_wavelength'),
    'fano_target_wavelengths': ('analysis', 'fano_target_wavelengths'),
    'svd_rank_threshold': ('analysis', 'svd_rank_threshold')}
