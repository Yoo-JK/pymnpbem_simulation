...
class DipoleStatIterRunner(SimulationRunner):
    """Iterative quasistatic dipole BEM (BEMStatIter, GMRES + ACA H-matrix).
    ...
    def run(self,
        ...
        print_info('DipoleStatIter: warming up at enei={:.1f} nm'.format(float(enei[0])))
        t_warm = time.time()
