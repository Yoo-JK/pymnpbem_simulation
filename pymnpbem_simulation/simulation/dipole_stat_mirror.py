...
class DipoleStatMirrorRunner(SimulationRunner):
    """Quasistatic dipole excitation near a mirror-symmetric particle (BEMStatMirror).
    ...
    def build_excitation(self) -> Any:
        ...
        from mnpbem.simulation import DipoleStatMirror
        ...
        return DipoleStatMirror(pt, dip = mom)
    ...
    def run(self,
        ...
        print_info('DipoleStatMirror: warming up at enei={:.1f} nm'.format(float(enei[0])))
        t_warm = time.time()
